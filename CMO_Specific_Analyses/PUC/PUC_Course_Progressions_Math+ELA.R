...
math.priors <- c('MATHEMATICS__MATHEMATICS__ALGEBRA_I', 'MATHEMATICS__GENERAL_MATHEMATICS', 'MATHEMATICS__ALGEBRA_I',
	'GENERAL_MATHEMATICS__ALGEBRA_I', 'ALGEBRA_I__GEOMETRY', 	### No kids in PUC 2012 Data with 'GEOMETRY__ALGEBRA_II',  ALGEBRA_I__GEOMETRY__ALGEBRA_II
...
for (prior in c(math.priors, ela.priors)) {
	...
	### No kids in PUC 2012 Data with any ALGEBRA_I__GEOMETRY__ALGEBRA_II progression
	...
	if (prior == 'MATHEMATICS__ALGEBRA_I')	{
		...
		### No kids in PUC 2012 Data with this EXACT progression
			# SCIENCE.2012 = list(
	...
	if (prior == 'ALGEBRA_I__GEOMETRY')	{
		...
		### No kids in PUC 2011 Data with this EXACT progression
		...
		### No kids in PUC 2012 Data with any GEOMETRY__ALGEBRA_II progression
...
# }
	...
	if (prior == 'GENERAL_MATHEMATICS')	{
		CA.config <- list(
			...
			INTEGRATED_SCIENCE_1.2012 = list(  #  No data for PUC
			...
			GENERAL_MATHEMATICS.2010 = list(  #  No data for PUC
				sgp.content.areas=c("GENERAL_MATHEMATICS", "GENERAL_MATHEMATICS"),  # course repeaters
	...
	if (prior == 'ALGEBRA_I')	{
		CA.config <- list(
			...
			BIOLOGY.2012 = list(
				...
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			SCIENCE.2012 = list(
				sgp.content.areas=c("ALGEBRA_I", "SCIENCE"),   #  No data for PUC
				sgp.panel.years=c('2011', '2012'),
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			...
			# EARTH_SCIENCE.2012 = list(
				...
				# sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			PHYSICS.2012 = list(
				sgp.content.areas=c("ALGEBRA_I", "PHYSICS"),   #  No data for PUC
				sgp.panel.years=c('2011', '2012'),
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			CHEMISTRY.2012 = list(
			...
			INTEGRATED_SCIENCE_1.2010 = list(
				sgp.content.areas=c("ALGEBRA_I", "INTEGRATED_SCIENCE_1"),   #  No data for PUC
				sgp.panel.years=c('2009', '2010'),
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
	...
	if (prior == 'GEOMETRY')	{
		CA.config <- list(
			ALGEBRA_I.2012 = list(
				...
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			GEOMETRY.2012 = list(
				sgp.content.areas=c("GEOMETRY", "GEOMETRY"), # course repeaters   #  No data for PUC
				sgp.panel.years=c('2011', '2012'),
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			ALGEBRA_II.2012 = list(
			...
			ALGEBRA_I.2010 = list(
				sgp.content.areas=c("GEOMETRY", "ALGEBRA_I"),  #  No data for PUC
				sgp.panel.years=c('2009', '2010'),
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),				
			GEOMETRY.2010 = list(
			...
			BIOLOGY.2010 = list(
				...
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			PHYSICS.2010 = list(
				sgp.content.areas=c("GEOMETRY", "PHYSICS"),   #  No data for PUC
				sgp.panel.years=c('2009', '2010'),
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			CHEMISTRY.2010 = list(
				sgp.content.areas=c("GEOMETRY", "CHEMISTRY"), 
			...
			BIOLOGY.2011 = list(
				sgp.content.areas=c("GEOMETRY", "BIOLOGY"),  #  No data for PUC
				sgp.panel.years=c('2010', '2011'),
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			PHYSICS.2011 = list(
				sgp.content.areas=c("GEOMETRY", "PHYSICS"),  #  No data for PUC
	...
	if (prior == 'ALGEBRA_II')	{
		CA.config <- list(
			...
			BIOLOGY.2010 = list(
				...
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			PHYSICS.2010 = list(
				sgp.content.areas=c("ALGEBRA_II", "PHYSICS"),   #  No data for PUC
				sgp.panel.years=c('2009', '2010'),
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			CHEMISTRY.2010 = list(
				sgp.content.areas=c("ALGEBRA_II", "CHEMISTRY"), 
	...
	if (prior == 'SUMMATIVE_HS_MATHEMATICS')	{
		CA.config <- list(
			SUMMATIVE_HS_MATHEMATICS.2012 = list(
				...
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			SUMMATIVE_HS_MATHEMATICS.2010 = list(
				sgp.content.areas=c("SUMMATIVE_HS_MATHEMATICS", "SUMMATIVE_HS_MATHEMATICS"),  #  No data for PUC
				sgp.panel.years=c('2009', '2010'),
				sgp.grade.sequences=list(c('EOCT', 'EOCT'))),
			SUMMATIVE_HS_MATHEMATICS.2011 = list(
				sgp.content.areas=c("SUMMATIVE_HS_MATHEMATICS", "SUMMATIVE_HS_MATHEMATICS"),
...
######################################################################################################
	...
	Goodness_of_Fit[["BY_PRIOR"]][[prior]] <- PUC_SGP@SGP[["Goodness_of_Fit"]]
	Knots_Boundaries[["BY_PRIOR"]][[prior]] <- PUC_SGP@SGP[["Knots_Boundaries"]]
	...
	if (prior %in% math.priors) {
		for (i in maths) {
			for (y in c('2010', '2011', '2012')) {
				...
				if (tmp.subj %in% names(PUC_SGP@SGP[["SGPercentiles"]])) {
					# PUC_SGP@SGP[["SGPercentiles"]][[tmp.subj]][['PRIOR_TYPE']] <- 1
					PUC_SGP@SGP[["SGPercentiles"]][[tmp.subj]][['PRIOR_PREF']] <- prior.pref
					# PUC_SGP@SGP[["SGPercentiles"]][[tmp.subj]][['SGP_PRIORS_USED']] <- prior
					SGPercentiles[[tmp.subj]] <- rbind(SGPercentiles[[tmp.subj]], PUC_SGP@SGP[["SGPercentiles"]][[tmp.subj]])
				}
			}
		}
		for (i in c(sciences)) {
			for (y in c('2010', '2011', '2012')) {
				tmp.subj<-paste(i, y, sep=".") 
				if (tmp.subj %in% names(PUC_SGP@SGP[["SGPercentiles"]])) {
					# PUC_SGP@SGP[["SGPercentiles"]][[tmp.subj]][['PRIOR_TYPE']] <- 2
					PUC_SGP@SGP[["SGPercentiles"]][[tmp.subj]][['PRIOR_PREF']] <- prior.pref
					# PUC_SGP@SGP[["SGPercentiles"]][[tmp.subj]][['SGP_PRIORS_USED']] <- prior
					SGPercentiles[[tmp.subj]] <- rbind(SGPercentiles[[tmp.subj]], PUC_SGP@SGP[["SGPercentiles"]][[tmp.subj]])
				}
